...
`,Ze=`# Quantum Data Management PhD Work
...
`,en=[{slug:"phd",company:"TU Delft",description:Ze,contract:Q.FullTime,type:"Doctoral Research",location:"Delft, Netherlands",period:{from:new Date(2024,8,15)},skills:x("python","sql","postgres","qiskit"),name:"PhD candidate",color:"blue",links:[],logo:d.Delft,shortDescription:"Doctoral Research in Quantum Data Management and classical simulation of quantum systems"},{slug:"freelance software-developer",company:"Self-employed",description:Je,contract:Q.SelfEmployed,type:"Software Development",location:"Hamburg, Germany / Bremen, Germany",period:{from:new Date(2022,9,1),to:new Date(2024,3,31)},skills:x("angular","ts","python","css","html","js","django","sql","postgres","docker","redis","celery"),name:"Freelance Data Scientist / Software Developer",color:"green",links:[],logo:d.DSTL,shortDescription:"Data Science and Web development for customers."},{slug:"data-scientist",company:"Self-employed",description:We,contract:Q.SelfEmployed,type:"Data Science",location:"Hamburg, Germany",period:{from:new Date(2021,0,10),to:new Date(2022,8,1)},skills:x("python","sql","postgres","docker","redis","celery","pandas","pytorch","numpy","golang","opencv"),name:"Data Scientist",color:"blue",links:[],logo:d.UKE,shortDescription:"Data Analytics and Machine Learning Services for customers."},{slug:"co-founder",company:"trilitec GmbH",description:Ve,contract:Q.FullTime,type:"Data Science",location:"Osterholz-Scharmbeck, Germany",period:{from:new Date(2020,2,10),to:new Date(2021,8,1)},skills:x("python","sql","postgres","docker","pandas","pytorch","numpy","clang","cpp","opencv"),name:"Co-Founder",color:"blue",links:[],logo:d.trilitec,shortDescription:"Leading the Data Science and Software Development department at trilitec Startup."},{slug:"technology-consultant",company:"Lufthansa Industry Solutions GmbH",description:Ye,contract:Q.FullTime,type:"Data Science",location:"Hamburg, Germany",period:{from:new Date(2019,8,10),to:new Date(2020,2,1)},skills:x("python","sql","postgres","docker","pandas","pytorch","numpy","javascript","css","html"),name:"Technology Consultant",color:"blue",links:[],logo:d.LHIND,shortDescription:"Consulting customers in the field of software development and data science."},{slug:"intern",company:"DFKI GmbH",description:Ke,contract:Q.Internship,type:"Research Internship",location:"Bremen, Germany",period:{from:new Date(2019,1,10),to:new Date(2019,6,1)},skills:x("python","tensorflow","qt","ros","cpp","clang"),name:"Intern",color:"blue",links:[],logo:d.DFKI,shortDescription:"Developing a new generation of autonomous driving software."},{slug:"student-researcher",company:"Institute for nuclear physics at Uppsala University",description:Xe,contract:Q.StudentJob,type:"Research Internship",location:"Uppsala, Sweden",period:{from:new Date(2018,10,1),to:new Date(2019,0,1)},skills:x("python","tensorflow","root"),name:"Student Researcher",color:"red",links:[],logo:d.Uppsala,shortDescription:"Development and implementation of a Bayesian Neural Network for the analysis of nuclear physics data."}],nn=`# Accounting Tool
...
`,tn=`# Character Sheet Web Application
...
Feel free to explore the repository for more details on the implementation and to contribute to the project if you're interested!`,an=`# Game Engine (C++)

## Introduction
My most recent challenge I started in 2024 is the development of my own 3D Game Engine. 

## (WIP)
Since the Engine is quite early in development, there is not much to show yet, so please check in later for an updated description of my experience on this journey.`,on=`# Flyfe Game
...
`,sn=`# Image Labelling Tool for Neuropathological Image Analysis
...
`,rn=`# Project Description: IMU Analyzer
...
`,ln=`To finish a course in Computer Graphics I had to show a PBR textured object. In order to do that I built a model viewer in C++ using OpenGL to show different attributes of the model such as diffuse, metalness, specular and ambient occlusion texture. 
...
`,cn=`# Bayesian Neural Network for BESIII Spectrometer Data Analysis
