...
for word in word_list:
    print(word)
\`\`\`
`,Ie=`# SQL (Structured Query Language)
...
`,je=`# Root Data Analysis Framework
...
\`\`\``,Ue=`# HTML: Hypertext Markup Language
...
`,y=e=>e,pe=[y({slug:"python",color:"yellow",description:Ce,logo:d.Python,name:"Python"}),y({slug:"c",color:"blue",description:we,logo:d.C,name:"C"}),y({slug:"cpp",color:"blue",description:Se,logo:d.Cpp,name:"C++"}),y({slug:"go",color:"blue",description:ke,logo:d.Go,name:"Golang"}),y({slug:"sql",color:"blue",description:Ie,logo:d.SQL,name:"SQL"}),y({slug:"postgres",color:"blue",description:Me,logo:d.PostgreSQL,name:"PostgreSQL"}),y({slug:"django",color:"green",description:Le,logo:d.Django,name:"Django"}),y({slug:"pytorch",color:"red",description:xe,logo:d.PyTorch,name:"Pytorch"}),y({slug:"tensorflow",color:"orange",description:Pe,logo:d.Tensorflow,name:"Tensorflow"}),y({slug:"pandas",color:"red",description:ze,logo:d.Pandas,name:"Pandas"}),y({slug:"numpy",color:"blue",description:Ae,logo:d.Numpy,name:"Numpy"}),y({slug:"celery",color:"green",description:$e,logo:d.Celery,name:"Celery"}),y({slug:"root",color:"blue",description:je,logo:d.ROOT,name:"Root"}),y({slug:"qt",color:"green",description:Oe,logo:d.QT,name:"Qt"}),y({slug:"ros",color:"blue",description:Ee,logo:d.ROS,name:"ROS"}),y({slug:"opencv",color:"blue",description:He,logo:d.OpenCV,name:"OpenCV"}),y({slug:"electron",color:"blue",description:Re,logo:d.Electron,name:"Electron"}),y({slug:"opengl",color:"blue",description:Ge,logo:d.OpenGL,name:"OpenGL"}),y({slug:"css",color:"blue",description:Fe,logo:d.CSS,name:"CSS"}),y({slug:"html",color:"orange",description:Ue,logo:d.HTML,name:"HTML"}),y({slug:"javascript",color:"yellow",description:Te,logo:d.JavaScript,name:"Javascript"}),y({slug:"svelte",color:"orange",description:ve,logo:d.Svelte,name:"Svelte"}),y({slug:"angular",color:"red",description:be,logo:d.Angular,name:"Angular"}),y({slug:"ts",color:"blue",description:De,logo:d.TypeScript,name:"Typescript"}),y({slug:"tailwind",color:"blue",description:Ne,logo:d.Tailwind,name:"Tailwind"}),y({slug:"docker",color:"blue",description:_e,logo:d.Docker,name:"Docker"}),y({slug:"redis",color:"red",description:Be,logo:d.Redis,name:"Redis"}),y({slug:"unreal",color:"blue",description:Je,logo:d.UnrealEngine,name:"Unreal Engine"}),y({slug:"blender",color:"orange",description:Qe,logo:d.Blender,name:"Blender"})],P=(...e)=>pe.filter(v=>e.includes(v.slug));var q=(e=>(e.GitHub="github",e.StackOverflow="stackoverflow",e.Twitter="twitter",e.Linkedin="linkedin",e.Email="email",e.Facebook="facebook",e.Youtube="youtube",e))(q||{}),W=(e=>(e.FullTime="Full-time",e.PartTime="Part-time",e.SelfEmployed="Self-employed",e.Freelance="Freelance",e.Contract="Contract",e.Internship="Internship",e.StudentJob="Student Job",e))(W||{});const We=[{slug:"freelance software-developer",company:"Self-employed",description:"Data Science and Web development for customers.",contract:W.SelfEmployed,type:"Software Development",location:"Hamburg, Germany / Bremen, Germany",period:{from:new Date(2022,9,1)},skills:P("angular","ts","python","css","html","js","django","sql","postgres","docker","redis","celery"),name:"Freelance Data Scientist / Software Developer",color:"green",links:[],logo:d.DSTL,shortDescription:"Data Science and Web development for customers."},{slug:"data-scientist",company:"Self-employed",description:"Creating awesome tools for developers.",contract:W.SelfEmployed,type:"Data Science",location:"Hamburg, Germany",period:{from:new Date(2021,0,10),to:new Date(2022,8,1)},skills:P("python","sql","postgres","docker","redis","celery","pandas","pytorch","numpy","golang","opencv"),name:"Data Scientist",color:"blue",links:[],logo:d.UKE,shortDescription:"Data Analytics and Machine Learning Services for customers."},{slug:"co-founder",company:"trilitec GmbH",description:"Leading the Data Science and Software Development department at trilitec Startup. Combning millimeter wave radar and machine learning to create a new generation of sensors.",contract:W.FullTime,type:"Data Science",location:"Osterholz-Scharmbeck, Germany",period:{from:new Date(2020,2,10),to:new Date(2021,8,1)},skills:P("python","sql","postgres","docker","pandas","pytorch","numpy","clang","cpp","opencv"),name:"Co-Founder",color:"blue",links:[],logo:d.trilitec,shortDescription:"Leading the Data Science and Software Development department at trilitec Startup."},{slug:"technology-consultant",company:"Lufthansa Industry Solutions GmbH",description:"Consulting customers in the field of software development and data science.",contract:W.FullTime,type:"Data Science",location:"Hamburg, Germany",period:{from:new Date(2019,8,10),to:new Date(2020,2,1)},skills:P("python","sql","postgres","docker","pandas","pytorch","numpy","javascript","css","html"),name:"Technology Consultant",color:"blue",links:[],logo:d.LHIND,shortDescription:"Consulting customers in the field of software development and data science."},{slug:"intern",company:"DFKI GmbH",description:"Developing a new generation of autonomous driving software.",contract:W.Internship,type:"Research Internship",location:"Bremen, Germany",period:{from:new Date(2019,1,10),to:new Date(2019,6,1)},skills:P("python","tensorflow","qt","ros","cpp","clang"),name:"Intern",color:"blue",links:[],logo:d.DFKI,shortDescription:"Developing a new generation of autonomous driving software."},{slug:"student-researcher",company:"Institute for nuclear physics at Uppsala University",description:"Development and implementation of a Bayesian Neural Network for the analysis of nuclear physics data.",contract:W.StudentJob,type:"Research Internship",location:"Uppsala, Sweden",period:{from:new Date(2018,10,1),to:new Date(2019,0,1)},skills:P("python","tensorflow","root"),name:"Student Researcher",color:"red",links:[],logo:d.Uppsala,shortDescription:"Development and implementation of a Bayesian Neural Network for the analysis of nuclear physics data."}],qe=`# Accounting Tool
...
`,Ve=`# Character Sheet Web Application
...
Feel free to explore the repository for more details on the implementation and to contribute to the project if you're interested!`,Ye=`# Game Engine (C++)

## Introduction
My most recent challenge I started in 2024 is the development of my own 3D Game Engine. 

## (WIP)
Since the Engine is quite early in development, there is not much to show yet, so please check in later for an updated description of my experience on this journey.`,Ke=`# Flyfe Game
...
`,Xe=`# Image Labelling Tool for Neuropathological Image Analysis
...
`,Ze=`# Project Description: IMU Analyzer
...
`,en=`To finish a course in Computer Graphics I had to show a PBR textured object. In order to do that I built a model viewer in C++ using OpenGL to show different attributes of the model such as diffuse, metalness, specular and ambient occlusion texture. 
...
`,nn=`# Bayesian Neural Network for BESIII Spectrometer Data Analysis
...
`,tn=[{slug:"character-sheet",color:"green",description:Ve,shortDescription:"Character Sheet developed in Python using Django.",links:[{to:"https://github.com/tmlittau/character-sheet",label:"GitHub"}],logo:d.DSTL,name:"Character Sheet",period:{from:new Date(2022,9,1),to:new Date(2023,0,1)},skills:P("python","django","sql","svelte","javascript","css","html"),type:"Web based Character Sheet for Pen and Paper Games",screenshots:[{label:"Character Creator when first logging in",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/cs_project/charcreator_demo.jpg?raw=true"},{label:"Character Sheet with all the information",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/cs_project/charactersheet_demo.jpg?raw=true"}]},{slug:"accounting-tool",color:"green",description:qe,shortDescription:"Accounting Tool developed in Python using Django.",links:[{to:"https://github.com/tmlittau/accounting_backend",label:"GitHub"},{to:"https://github.com/tmlittau/accounting_frontend",label:"GitHub"}],logo:d.DSTL,name:"Accounting Tool",period:{from:new Date(2022,9,1),to:new Date(2023,0,1)},skills:P("python","django","sql","postgres","docker","redis"),type:"Web based Accounting Tool for a small business",screenshots:[{label:"Tax Form to calculate yearly taxes",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/at_project/eur_demo.jpg?raw=true"},{label:"VAT Declaration Form to calculate quarterly/monthly VAT",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/at_project/ustva_demo.jpg?raw=true"},{label:"Support for different Users",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/at_project/user_management.jpg?raw=true"},{label:"New Invoice Entry",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/at_project/new_invoice.jpg?raw=true"},{label:"New Customer Entry",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/at_project/new_customer_entry.jpg?raw=true"}]},{slug:"game-engine",color:"blue",description:Ye,shortDescription:"Game Engine developed in C++ using OpenGL.",links:[],logo:d.Unknown,name:"Game Engine",period:{from:new Date(2024,0,1)},skills:P("cpp","opengl"),type:"Game Engine"},{slug:"game-jam-2022",color:"green",description:Ke,shortDescription:"GameDev.tv GameJam 2022",links:[{to:"https://physikar.itch.io/flyfe",label:"itch.io"},{to:"https://www.youtube.com/watch?v=AKiOL-J0yak",label:"YouTube"}],logo:d.GameDevTV,name:"GameDev.tv Game Jam 2022",period:{from:new Date(2022,4,20),to:new Date(2022,4,31)},skills:P("cpp","unreal","blender"),type:"Game Development",screenshots:[{label:"Main Menu",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/flyfe_project/0.png?raw=true"},{label:"Obstacles to limit progression",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/flyfe_project/1.png?raw=true"},{label:'Player Base with "nesting grounds"',src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/flyfe_project/2.png?raw=true"},{label:"Ore to collect and build with",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/flyfe_project/3.png?raw=true"},{label:"Fiber plants to collect and build with",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/flyfe_project/4.png?raw=true"}]},{slug:"image-labelling-tool",color:"blue",description:Xe,shortDescription:"Image Labelling Tool developed in Golang using Electron for the GUI.",links:[],logo:d.UKE,name:"Image Labelling Tool",period:{from:new Date(2021,9,1),to:new Date(2022,8,1)},skills:P("golang","electron","typescript","css","html"),type:"Data Analysis Tool for Labelling Images",screenshots:[{label:"Example of the GUI",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/lt_project/roi_labelling.jpg?raw=true"}]},{slug:"imu-analyzer",color:"blue",description:Ze,shortDescription:"IMU Analyzer developed in Python using PyQT.",links:[{to:"https://github.com/tmlittau/legacy_portfolio",label:"GitHub"}],logo:d.DFKI,name:"IMU Analyzer",period:{from:new Date(2017,1,1),to:new Date(2017,4,1)},skills:P("python","qt","ros"),type:"Analysis Tool for IMU Data",screenshots:[{label:"Example of the GUI",src:"https://raw.githubusercontent.com/tmlittau/legacy_portfolio/main/IMU_Analyzer/IMU_Analyzer.png"}]},{slug:"model-viewer",color:"#ff3e00",description:en,shortDescription:"Model Viewer developed in C++ using OpenGL.",links:[{to:"https://github.com/tmlittau/legacy_portfolio",label:"GitHub"}],logo:d.Uppsala,name:"Model Viewer",period:{from:new Date(2018,0,15),to:new Date(2018,5,1)},skills:P("cpp","opengl"),type:"Computer Graphics Demo Project",screenshots:[{label:"Example of the Model Viewer",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/mv_project/model_viewer_demo.jpg?raw=true"}]},{slug:"bayesian-neural-network",color:"red",description:nn,shortDescription:"Bayesian Neural Network developed in Python using PyTorch.",links:[{to:"https://github.com/tmlittau/legacy_portfolio",label:"GitHub"}],logo:d.Uppsala,name:"Bayesian Neural Network",period:{from:new Date(2018,10,1),to:new Date(2019,0,5)},skills:P("python","tensorflow","root"),type:"Data Analysis Script",screenshots:[{label:"Project Poster",src:"https://github.com/tmlittau/tmlittau-portfolio/blob/master/static/img/bnn_project/Project09_poster.pdf?raw=true"}]}];var me=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},se={},an={get exports(){return se},set exports(e){se=e}};(function(e,v){(function(w,h){e.exports=h()})(me,function(){var w=1e3,h=6e4,k=36e5,C="millisecond",I="second",E="minute",G="hour",$="day",F="week",z="month",U="quarter",A="year",j="date",N="Invalid Date",X=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,R=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,ae={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(s){var i=["th","st","nd","rd"],t=s%100;return"["+s+(i[(t-20)%10]||i[t]||i[0])+"]"}},H=function(s,i,t){var r=String(s);return!r||r.length>=i?s:""+Array(i+1-r.length).join(t)+s},Z={s:H,z:function(s){var i=-s.utcOffset(),t=Math.abs(i),r=Math.floor(t/60),a=t%60;return(i<=0?"+":"-")+H(r,2,"0")+":"+H(a,2,"0")},m:function s(i,t){if(i.date()<t.date())return-s(t,i);var r=12*(t.year()-i.year())+(t.month()-i.month()),a=i.clone().add(r,z),u=t-a<0,p=i.clone().add(r+(u?-1:1),z);return+(-(r+(t-a)/(u?a-p:p-a))||0)},a:function(s){return s<0?Math.ceil(s)||0:Math.floor(s)},p:function(s){return{M:z,y:A,w:F,d:$,D:j,h:G,m:E,s:I,ms:C,Q:U}[s]||String(s||"").toLowerCase().replace(/s$/,"")},u:function(s){return s===void 0}},_="en",g={};g[_]=ae;var l="$isDayjsObject",o=function(s){return s instanceof T||!(!s||!s[l])},f=function s(i,t,r){var a;if(!i)return _;if(typeof i=="string"){var u=i.toLowerCase();g[u]&&(a=u),t&&(g[u]=t,a=u);var p=i.split("-");if(!a&&p.length>1)return s(p[0])}else{var b=i.name;g[b]=i,a=b}return!r&&a&&(_=a),a||!r&&_},m=function(s,i){if(o(s))return s.clone();var t=typeof i=="object"?i:{};return t.date=s,t.args=arguments,new T(t)},c=Z;c.l=f,c.i=o,c.w=function(s,i){return m(s,{locale:i.$L,utc:i.$u,x:i.$x,$offset:i.$offset})};var T=function(){function s(t){this.$L=f(t.locale,null,!0),this.parse(t),this.$x=this.$x||t.x||{},this[l]=!0}var i=s.prototype;return i.parse=function(t){this.$d=function(r){var a=r.date,u=r.utc;if(a===null)return new Date(NaN);if(c.u(a))return new Date;if(a instanceof Date)return new Date(a);if(typeof a=="string"&&!/Z$/i.test(a)){var p=a.match(X);if(p){var b=p[2]-1||0,S=(p[7]||"0").substring(0,3);return u?new Date(Date.UTC(p[1],b,p[3]||1,p[4]||0,p[5]||0,p[6]||0,S)):new Date(p[1],b,p[3]||1,p[4]||0,p[5]||0,p[6]||0,S)}}return new Date(a)}(t),this.init()},i.init=function(){var t=this.$d;this.$y=t.getFullYear(),this.$M=t.getMonth(),this.$D=t.getDate(),this.$W=t.getDay(),this.$H=t.getHours(),this.$m=t.getMinutes(),this.$s=t.getSeconds(),this.$ms=t.getMilliseconds()},i.$utils=function(){return c},i.isValid=function(){return this.$d.toString()!==N},i.isSame=function(t,r){var a=m(t);return this.startOf(r)<=a&&a<=this.endOf(r)},i.isAfter=function(t,r){return m(t)<this.startOf(r)},i.isBefore=function(t,r){return this.endOf(r)<m(t)},i.$g=function(t,r,a){return c.u(t)?this[r]:this.set(a,t)},i.unix=function(){return Math.floor(this.valueOf()/1e3)},i.valueOf=function(){return this.$d.getTime()},i.startOf=function(t,r){var a=this,u=!!c.u(r)||r,p=c.p(t),b=function(Q,x){var B=c.w(a.$u?Date.UTC(a.$y,x,Q):new Date(a.$y,x,Q),a);return u?B:B.endOf($)},S=function(Q,x){return c.w(a.toDate()[Q].apply(a.toDate("s"),(u?[0,0,0,0]:[23,59,59,999]).slice(x)),a)},D=this.$W,L=this.$M,O=this.$D,V="set"+(this.$u?"UTC":"");switch(p){case A:return u?b(1,0):b(31,11);case z:return u?b(1,L):b(0,L+1);case F:var J=this.$locale().weekStart||0,Y=(D<J?D+7:D)-J;return b(u?O-Y:O+(6-Y),L);case $:case j:return S(V+"Hours",0);case G:return S(V+"Minutes",1);case E:return S(V+"Seconds",2);case I:return S(V+"Milliseconds",3);default:return this.clone()}},i.endOf=function(t){return this.startOf(t,!1)},i.$set=function(t,r){var a,u=c.p(t),p="set"+(this.$u?"UTC":""),b=(a={},a[$]=p+"Date",a[j]=p+"Date",a[z]=p+"Month",a[A]=p+"FullYear",a[G]=p+"Hours",a[E]=p+"Minutes",a[I]=p+"Seconds",a[C]=p+"Milliseconds",a)[u],S=u===$?this.$D+(r-this.$W):r;if(u===z||u===A){var D=this.clone().set(j,1);D.$d[b](S),D.init(),this.$d=D.set(j,Math.min(this.$D,D.daysInMonth())).$d}else b&&this.$d[b](S);return this.init(),this},i.set=function(t,r){return this.clone().$set(t,r)},i.get=function(t){return this[c.p(t)]()},i.add=function(t,r){var a,u=this;t=Number(t);var p=c.p(r),b=function(L){var O=m(u);return c.w(O.date(O.date()+Math.round(L*t)),u)};if(p===z)return this.set(z,this.$M+t);if(p===A)return this.set(A,this.$y+t);if(p===$)return b(1);if(p===F)return b(7);var S=(a={},a[E]=h,a[G]=k,a[I]=w,a)[p]||1,D=this.$d.getTime()+t*S;return c.w(D,this)},i.subtract=function(t,r){return this.add(-1*t,r)},i.format=function(t){var r=this,a=this.$locale();if(!this.isValid())return a.invalidDate||N;var u=t||"YYYY-MM-DDTHH:mm:ssZ",p=c.z(this),b=this.$H,S=this.$m,D=this.$M,L=a.weekdays,O=a.months,V=a.meridiem,J=function(x,B,K,ee){return x&&(x[B]||x(r,u))||K[B].slice(0,ee)},Y=function(x){return c.s(b%12||12,x,"0")},Q=V||function(x,B,K){var ee=x<12?"AM":"PM";return K?ee.toLowerCase():ee};return u.replace(R,function(x,B){return B||function(K){switch(K){case"YY":return String(r.$y).slice(-2);case"YYYY":return c.s(r.$y,4,"0");case"M":return D+1;case"MM":return c.s(D+1,2,"0");case"MMM":return J(a.monthsShort,D,O,3);case"MMMM":return J(O,D);case"D":return r.$D;case"DD":return c.s(r.$D,2,"0");case"d":return String(r.$W);case"dd":return J(a.weekdaysMin,r.$W,L,2);case"ddd":return J(a.weekdaysShort,r.$W,L,3);case"dddd":return L[r.$W];case"H":return String(b);case"HH":return c.s(b,2,"0");case"h":return Y(1);case"hh":return Y(2);case"a":return Q(b,S,!0);case"A":return Q(b,S,!1);case"m":return String(S);case"mm":return c.s(S,2,"0");case"s":return String(r.$s);case"ss":return c.s(r.$s,2,"0");case"SSS":return c.s(r.$ms,3,"0");case"Z":return p}return null}(x)||p.replace(":","")})},i.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},i.diff=function(t,r,a){var u,p=this,b=c.p(r),S=m(t),D=(S.utcOffset()-this.utcOffset())*h,L=this-S,O=function(){return c.m(p,S)};switch(b){case A:u=O()/12;break;case z:u=O();break;case U:u=O()/3;break;case F:u=(L-D)/6048e5;break;case $:u=(L-D)/864e5;break;case G:u=L/k;break;case E:u=L/h;break;case I:u=L/w;break;default:u=L}return a?u:c.a(u)},i.daysInMonth=function(){return this.endOf(z).$D},i.$locale=function(){return g[this.$L]},i.locale=function(t,r){if(!t)return this.$L;var a=this.clone(),u=f(t,r,!0);return u&&(a.$L=u),a},i.clone=function(){return c.w(this.$d,this)},i.toDate=function(){return new Date(this.valueOf())},i.toJSON=function(){return this.isValid()?this.toISOString():null},i.toISOString=function(){return this.$d.toISOString()},i.toString=function(){return this.$d.toUTCString()},s}(),M=T.prototype;return m.prototype=M,[["$ms",C],["$s",I],["$m",E],["$H",G],["$W",$],["$M",z],["$y",A],["$D",j]].forEach(function(s){M[s[1]]=function(i){return this.$g(i,s[0],s[1])}}),m.extend=function(s,i){return s.$i||(s(i,T,m),s.$i=!0),m},m.locale=f,m.isDayjs=o,m.unix=function(s){return m(1e3*s)},m.en=g[_],m.Ls=g,m.p={},m})})(an);const ne=se;var re={},on={get exports(){return re},set exports(e){re=e}};(function(e,v){(function(w,h){e.exports=h()})(me,function(){var w,h,k=1e3,C=6e4,I=36e5,E=864e5,G=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,$=31536e6,F=2628e6,z=/^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/,U={years:$,months:F,days:E,hours:I,minutes:C,seconds:k,milliseconds:1,weeks:6048e5},A=function(g){return g instanceof Z},j=function(g,l,o){return new Z(g,o,l.$l)},N=function(g){return h.p(g)+"s"},X=function(g){return g<0},R=function(g){return X(g)?Math.ceil(g):Math.floor(g)},ae=function(g){return Math.abs(g)},H=function(g,l){return g?X(g)?{negative:!0,format:""+ae(g)+l}:{negative:!1,format:""+g+l}:{negative:!1,format:""}},Z=function(){function g(o,f,m){var c=this;if(this.$d={},this.$l=m,o===void 0&&(this.$ms=0,this.parseFromMilliseconds()),f)return j(o*U[N(f)],this);if(typeof o=="number")return this.$ms=o,this.parseFromMilliseconds(),this;if(typeof o=="object")return Object.keys(o).forEach(function(s){c.$d[N(s)]=o[s]}),this.calMilliseconds(),this;if(typeof o=="string"){var T=o.match(z);if(T){var M=T.slice(2).map(function(s){return s!=null?Number(s):0});return this.$d.years=M[0],this.$d.months=M[1],this.$d.weeks=M[2],this.$d.days=M[3],this.$d.hours=M[4],this.$d.minutes=M[5],this.$d.seconds=M[6],this.calMilliseconds(),this}}return this}var l=g.prototype;return l.calMilliseconds=function(){var o=this;this.$ms=Object.keys(this.$d).reduce(function(f,m){return f+(o.$d[m]||0)*U[m]},0)},l.parseFromMilliseconds=function(){var o=this.$ms;this.$d.years=R(o/$),o%=$,this.$d.months=R(o/F),o%=F,this.$d.days=R(o/E),o%=E,this.$d.hours=R(o/I),o%=I,this.$d.minutes=R(o/C),o%=C,this.$d.seconds=R(o/k),o%=k,this.$d.milliseconds=o},l.toISOString=function(){var o=H(this.$d.years,"Y"),f=H(this.$d.months,"M"),m=+this.$d.days||0;this.$d.weeks&&(m+=7*this.$d.weeks);var c=H(m,"D"),T=H(this.$d.hours,"H"),M=H(this.$d.minutes,"M"),s=this.$d.seconds||0;this.$d.milliseconds&&(s+=this.$d.milliseconds/1e3,s=Math.round(1e3*s)/1e3);var i=H(s,"S"),t=o.negative||f.negative||c.negative||T.negative||M.negative||i.negative,r=T.format||M.format||i.format?"T":"",a=(t?"-":"")+"P"+o.format+f.format+c.format+r+T.format+M.format+i.format;return a==="P"||a==="-P"?"P0D":a},l.toJSON=function(){return this.toISOString()},l.format=function(o){var f=o||"YYYY-MM-DDTHH:mm:ss",m={Y:this.$d.years,YY:h.s(this.$d.years,2,"0"),YYYY:h.s(this.$d.years,4,"0"),M:this.$d.months,MM:h.s(this.$d.months,2,"0"),D:this.$d.days,DD:h.s(this.$d.days,2,"0"),H:this.$d.hours,HH:h.s(this.$d.hours,2,"0"),m:this.$d.minutes,mm:h.s(this.$d.minutes,2,"0"),s:this.$d.seconds,ss:h.s(this.$d.seconds,2,"0"),SSS:h.s(this.$d.milliseconds,3,"0")};return f.replace(G,function(c,T){return T||String(m[c])})},l.as=function(o){return this.$ms/U[N(o)]},l.get=function(o){var f=this.$ms,m=N(o);return m==="milliseconds"?f%=1e3:f=m==="weeks"?R(f/U[m]):this.$d[m],f||0},l.add=function(o,f,m){var c;return c=f?o*U[N(f)]:A(o)?o.$ms:j(o,this).$ms,j(this.$ms+c*(m?-1:1),this)},l.subtract=function(o,f){return this.add(o,f,!0)},l.locale=function(o){var f=this.clone();return f.$l=o,f},l.clone=function(){return j(this.$ms,this)},l.humanize=function(o){return w().add(this.$ms,"ms").locale(this.$l).fromNow(!o)},l.valueOf=function(){return this.asMilliseconds()},l.milliseconds=function(){return this.get("milliseconds")},l.asMilliseconds=function(){return this.as("milliseconds")},l.seconds=function(){return this.get("seconds")},l.asSeconds=function(){return this.as("seconds")},l.minutes=function(){return this.get("minutes")},l.asMinutes=function(){return this.as("minutes")},l.hours=function(){return this.get("hours")},l.asHours=function(){return this.as("hours")},l.days=function(){return this.get("days")},l.asDays=function(){return this.as("days")},l.weeks=function(){return this.get("weeks")},l.asWeeks=function(){return this.as("weeks")},l.months=function(){return this.get("months")},l.asMonths=function(){return this.as("months")},l.years=function(){return this.get("years")},l.asYears=function(){return this.as("years")},g}(),_=function(g,l,o){return g.add(l.years()*o,"y").add(l.months()*o,"M").add(l.days()*o,"d").add(l.hours()*o,"h").add(l.minutes()*o,"m").add(l.seconds()*o,"s").add(l.milliseconds()*o,"ms")};return function(g,l,o){w=o,h=o().$utils(),o.duration=function(c,T){var M=o.locale();return j(c,{$l:M},T)},o.isDuration=A;var f=l.prototype.add,m=l.prototype.subtract;l.prototype.add=function(c,T){return A(c)?_(this,c,1):f.bind(this)(c,T)},l.prototype.subtract=function(c,T){return A(c)?_(this,c,-1):m.bind(this)(c,T)}}})})(on);const sn=re;ne.extend(sn);const dn=(e,v=new Date)=>{let w=0,h=0,k=0;return v.getFullYear()!==e.getFullYear()?(k=v.getMonth(),h=(v.getFullYear()-e.getFullYear()-1)*12,w=12-e.getMonth()):w=v.getMonth()-e.getMonth(),w+h+k+1},un=e=>["January","February","March","April","May","June","July","August","September","October","November","December"][e],pn=(e,v)=>`${e} | ${v}`;function mn(e,v=new Date(Date.now()+1e3*60*60*24)){const w=ne(e),h=ne(v),k=ne.duration(h.diff(w));let C=0,I="day";return k.as("days")<=7?(I="day",C=k.as("days")):k.as("months")<=1?(I="week",C=k.as("weeks")):k.as("years")<=1?(I="month",C=k.as("months")):(I="year",C=k.as("years")),C=Math.trunc(C),`${Math.trunc(C)} ${I}${C>1?"s":""}`}function hn(e,v){const w=["logo","links","color","screenshots"];return v=v.toLowerCase(),e.filter(h=>le(h,v,w))}function le(e,v,w=[]){return Array.isArray(e)?e.some(h=>le(h,v)):typeof e=="object"&&e!==null?e instanceof Date?[e.toString().toLowerCase(),e.toLocaleDateString("default",{month:"long",year:"numeric"}).toLowerCase(),e.toLocaleDateString("default",{day:"numeric",month:"long",year:"numeric"}).toLowerCase(),e.toLocaleDateString("en-US").toLowerCase(),e.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}).toLowerCase()].some(k=>k.includes(v)):Object.keys(e).some(h=>!w.includes(h)&&le(e[h],v)):e.toString().toLowerCase().includes(v)}var te=(e=>(e.Code="M5.854 4.854a.5.5 0 1 0-.708-.708l-3.5 3.5a.5.5 0 0 0 0 .708l3.5 3.5a.5.5 0 0 0 .708-.708L2.707 8l3.147-3.146zm4.292 0a.5.5 0 0 1 .708-.708l3.5 3.5a.5.5 0 0 1 0 .708l-3.5 3.5a.5.5 0 0 1-.708-.708L13.293 8l-3.147-3.146z",e.Search="M14.56 12.44L11.3 9.18a5.51 5.51 0 10-2.12 2.12l3.26 3.26a1.5 1.5 0 102.12-2.12zM3 6.5A3.5 3.5 0 116.5 10 3.5 3.5 0 013 6.5z",e.Email="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10h5v-2h-5c-4.34 0-8-3.66-8-8s3.66-8 8-8 8 3.66 8 8v1.43c0 .79-.71 1.57-1.5 1.57s-1.5-.78-1.5-1.57V12c0-2.76-2.24-5-5-5s-5 2.24-5 5 2.24 5 5 5c1.38 0 2.64-.56 3.54-1.47.65.89 1.77 1.47 2.96 1.47 1.97 0 3.5-1.6 3.5-3.57V12c0-5.52-4.48-10-10-10zm0 13c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z",e.Skills="M19 5a3 3 0 00-3-3H5v20l7-6.29L19 22z",e.GitHub="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z",e.StackOverflow="m17.12 21.857h-14.977v-6.428h-2.143v8.571h19.259v-8.571h-2.139zm-12.616-7.018.442-2.102 10.486 2.21-.442 2.09zm1.379-5.009.898-1.955 9.71 4.54-.898 1.942zm2.692-4.768 1.366-1.647 8.218 6.87-1.366 1.647zm5.313-5.062 6.388 8.585-1.716 1.286-6.386-8.585zm-9.616 19.701v-2.13h10.714v2.13z",e.LinkedIn="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5a1.78 1.78 0 01-1.8 1.75zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93A1.74 1.74 0 0013 14.19a.66.66 0 000 .14V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.36.86 3.36 3.66z",e.Twitter="M23.643 4.937c-.835.37-1.732.62-2.675.733.962-.576 1.7-1.49 2.048-2.578-.9.534-1.897.922-2.958 1.13-.85-.904-2.06-1.47-3.4-1.47-2.572 0-4.658 2.086-4.658 4.66 0 .364.042.718.12 1.06-3.873-.195-7.304-2.05-9.602-4.868-.4.69-.63 1.49-.63 2.342 0 1.616.823 3.043 2.072 3.878-.764-.025-1.482-.234-2.11-.583v.06c0 2.257 1.605 4.14 3.737 4.568-.392.106-.803.162-1.227.162-.3 0-.593-.028-.877-.082.593 1.85 2.313 3.198 4.352 3.234-1.595 1.25-3.604 1.995-5.786 1.995-.376 0-.747-.022-1.112-.065 2.062 1.323 4.51 2.093 7.14 2.093 8.57 0 13.255-7.098 13.255-13.254 0-.2-.005-.402-.014-.602.91-.658 1.7-1.477 2.323-2.41z",e.Home="M23 9v2h-2v7a3 3 0 01-3 3h-4v-6h-4v6H6a3 3 0 01-3-3v-7H1V9l11-7 5 3.18V2h3v5.09z",e.Projects="M3 3h4v4H3zm7 4h4V3h-4zm7-4v4h4V3zM3 14h4v-4H3zm7 0h4v-4h-4zm7 0h4v-4h-4zM3 21h4v-4H3zm7 0h4v-4h-4zm7 0h4v-4h-4z",e.Job="M17 6V5a3 3 0 00-3-3h-4a3 3 0 00-3 3v1H2v4a3 3 0 003 3h14a3 3 0 003-3V6zM9 5a1 1 0 011-1h4a1 1 0 011 1v1H9zm10 9a4 4 0 003-1.38V17a3 3 0 01-3 3H5a3 3 0 01-3-3v-4.38A4 4 0 005 14z",e.Academic="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z",e.Resume="M3 3v15a3 3 0 003 3h9v-6h6V3zm9 8H6v-1h6zm6-3H6V7h12zm-2 8h5l-5 5z",e.RightArrow="M9.4,18.4l-0.7-0.7l5.6-5.6L8.6,6.4l0.7-0.7l6.4,6.4L9.4,18.4z",e.LeftArrow="M14.6,18.4L8.3,12l6.4-6.4l0.7,0.7L9.7,12l5.6,5.6L14.6,18.4z",e.Youtube="M365.257,67.393H95.744C42.866,67.393,0,110.259,0,163.137v134.728 c0,52.878,42.866,95.744,95.744,95.744h269.513c52.878,0,95.744-42.866,95.744-95.744V163.137 C461.001,110.259,418.135,67.393,365.257,67.393z M300.506,237.056l-126.06,60.123c-3.359,1.602-7.239-0.847-7.239-4.568V168.607 c0-3.774,3.982-6.22,7.348-4.514l126.06,63.881C304.363,229.873,304.298,235.248,300.506,237.056z",e.Link="M19.83 4.17a4 4 0 00-5.66 0l-2 2A4 4 0 0011 9a4 4 0 00.56 2l-.54.54a4 4 0 00-4.85.63l-2 2a4 4 0 005.66 5.66l2-2A4 4 0 0013 15a4 4 0 00-.56-2l.54-.54a4 4 0 004.85-.63l2-2a4 4 0 000-5.66zM11 15a2 2 0 01-.59 1.41l-2 2a2 2 0 11-3-2.6l.22-.22 2-2A2 2 0 019 13a2.24 2.24 0 01.51.07l-1.22 1.22a1 1 0 000 1.41 1 1 0 001.41 0l1.22-1.22A2.24 2.24 0 0111 15zm7.41-6.59l-2 2A2 2 0 0115 11a2.24 2.24 0 01-.51-.07l1.22-1.22A1 1 0 0016 9a1 1 0 00-.29-.7A1 1 0 0015 8a1 1 0 00-.7.29l-1.23 1.22A2.24 2.24 0 0113 9a2 2 0 01.59-1.41l2-2a2 2 0 013 2.6z",e.Sun="M108.5 24C108.5 27.5902136 105.590214 30.5 102 30.5 98.4097864 30.5 95.5 27.5902136 95.5 24 95.5 20.4097864 98.4097864 17.5 102 17.5 105.590214 17.5 108.5 20.4097864 108.5 24zM107 24C107 21.2382136 104.761786 19 102 19 99.2382136 19 97 21.2382136 97 24 97 26.7617864 99.2382136 29 102 29 104.761786 29 107 26.7617864 107 24zM101 12.75L101 14.75C101 15.1642136 101.335786 15.5 101.75 15.5 102.164214 15.5 102.5 15.1642136 102.5 14.75L102.5 12.75C102.5 12.3357864 102.164214 12 101.75 12 101.335786 12 101 12.3357864 101 12.75zM95.7255165 14.6323616L96.7485165 16.4038616C96.9556573 16.7625614 97.4143618 16.8854243 97.7730616 16.6782835 98.1317614 16.4711427 98.2546243 16.0124382 98.0474835 15.6537384L97.0244835 13.8822384C96.8173427 13.5235386 96.3586382 13.4006757 95.9999384 13.6078165 95.6412386 13.8149573 95.5183757 14.2736618 95.7255165 14.6323616zM91.8822384 19.0244835L93.6537384 20.0474835C94.0124382 20.2546243 94.4711427 20.1317614 94.6782835 19.7730616 94.8854243 19.4143618 94.7625614 18.9556573 94.4038616 18.7485165L92.6323616 17.7255165C92.2736618 17.5183757 91.8149573 17.6412386 91.6078165 17.9999384 91.4006757 18.3586382 91.5235386 18.8173427 91.8822384 19.0244835zM90.75 25L92.75 25C93.1642136 25 93.5 24.6642136 93.5 24.25 93.5 23.8357864 93.1642136 23.5 92.75 23.5L90.75 23.5C90.3357864 23.5 90 23.8357864 90 24.25 90 24.6642136 90.3357864 25 90.75 25zM92.6323616 30.2744835L94.4038616 29.2514835C94.7625614 29.0443427 94.8854243 28.5856382 94.6782835 28.2269384 94.4711427 27.8682386 94.0124382 27.7453757 93.6537384 27.9525165L91.8822384 28.9755165C91.5235386 29.1826573 91.4006757 29.6413618 91.6078165 30.0000616 91.8149573 30.3587614 92.2736618 30.4816243 92.6323616 30.2744835zM97.0244835 34.1177616L98.0474835 32.3462616C98.2546243 31.9875618 98.1317614 31.5288573 97.7730616 31.3217165 97.4143618 31.1145757 96.9556573 31.2374386 96.7485165 31.5961384L95.7255165 33.3676384C95.5183757 33.7263382 95.6412386 34.1850427 95.9999384 34.3921835 96.3586382 34.5993243 96.8173427 34.4764614 97.0244835 34.1177616zM103 35.25L103 33.25C103 32.8357864 102.664214 32.5 102.25 32.5 101.835786 32.5 101.5 32.8357864 101.5 33.25L101.5 35.25C101.5 35.6642136 101.835786 36 102.25 36 102.664214 36 103 35.6642136 103 35.25zM108.274483 33.3676384L107.251483 31.5961384C107.044343 31.2374386 106.585638 31.1145757 106.226938 31.3217165 105.868239 31.5288573 105.745376 31.9875618 105.952517 32.3462616L106.975517 34.1177616C107.182657 34.4764614 107.641362 34.5993243 108.000062 34.3921835 108.358761 34.1850427 108.481624 33.7263382 108.274483 33.3676384zM112.117762 28.9755165L110.346262 27.9525165C109.987562 27.7453757 109.528857 27.8682386 109.321717 28.2269384 109.114576 28.5856382 109.237439 29.0443427 109.596138 29.2514835L111.367638 30.2744835C111.726338 30.4816243 112.185043 30.3587614 112.392183 30.0000616 112.599324 29.6413618 112.476461 29.1826573 112.117762 28.9755165zM113.25 23L111.25 23C110.835786 23 110.5 23.3357864 110.5 23.75 110.5 24.1642136 110.835786 24.5 111.25 24.5L113.25 24.5C113.664214 24.5 114 24.1642136 114 23.75 114 23.3357864 113.664214 23 113.25 23zM111.367638 17.7255165L109.596138 18.7485165C109.237439 18.9556573 109.114576 19.4143618 109.321717 19.7730616 109.528857 20.1317614 109.987562 20.2546243 110.346262 20.0474835L112.117762 19.0244835C112.476461 18.8173427 112.599324 18.3586382 112.392183 17.9999384 112.185043 17.6412386 111.726338 17.5183757 111.367638 17.7255165zM106.975517 13.8822384L105.952517 15.6537384C105.745376 16.0124382 105.868239 16.4711427 106.226938 16.6782835 106.585638 16.8854243 107.044343 16.7625614 107.251483 16.4038616L108.274483 14.6323616C108.481624 14.2736618 108.358761 13.8149573 108.000062 13.6078165 107.641362 13.4006757 107.182657 13.5235386 106.975517 13.8822384z",e.Moon="M102,21 C102,18.1017141 103.307179,15.4198295 105.51735,13.6246624 C106.001939,13.2310647 105.821611,12.4522936 105.21334,12.3117518 C104.322006,12.1058078 103.414758,12 102.5,12 C95.8722864,12 90.5,17.3722864 90.5,24 C90.5,30.6277136 95.8722864,36 102.5,36 C106.090868,36 109.423902,34.4109093 111.690274,31.7128995 C112.091837,31.2348572 111.767653,30.5041211 111.143759,30.4810139 C106.047479,30.2922628 102,26.1097349 102,21 Z M102.5,34.5 C96.7007136,34.5 92,29.7992864 92,24 C92,18.2007136 96.7007136,13.5 102.5,13.5 C102.807386,13.5 103.113925,13.5136793 103.419249,13.5407785 C101.566047,15.5446378 100.5,18.185162 100.5,21 C100.5,26.3198526 104.287549,30.7714322 109.339814,31.7756638 L109.516565,31.8092927 C107.615276,33.5209452 105.138081,34.5 102.5,34.5 Z",e.Facebook="M353.701,0H55.087C24.665,0,0.002,24.662,0.002,55.085v298.616c0,30.423,24.662,55.085,55.085,55.085 h147.275l0.251-146.078h-37.951c-4.932,0-8.935-3.988-8.954-8.92l-0.182-47.087c-0.019-4.959,3.996-8.989,8.955-8.989h37.882 v-45.498c0-52.8,32.247-81.55,79.348-81.55h38.65c4.945,0,8.955,4.009,8.955,8.955v39.704c0,4.944-4.007,8.952-8.95,8.955 l-23.719,0.011c-25.615,0-30.575,12.172-30.575,30.035v39.389h56.285c5.363,0,9.524,4.683,8.892,10.009l-5.581,47.087 c-0.534,4.506-4.355,7.901-8.892,7.901h-50.453l-0.251,146.078h87.631c30.422,0,55.084-24.662,55.084-55.084V55.085 C408.786,24.662,384.124,0,353.701,0z",e))(te||{});const gn="Tim Littau Portfolio",fn={home:"Home",personal:"Projects",career:"Experiences",resume:"Resume",skills:"Skills",Education:"Education"},yn=e=>{switch(e){case q.GitHub:return te.GitHub;case q.Linkedin:return te.LinkedIn;case q.Email:return te.Email}},vn={title:"Home",name:"Tim",lastName:"LITTAU",description:"Data Scientist by education, Software Developer by nature.",links:[{platform:q.GitHub,link:"https://github.com/tmlittau"},{platform:q.Linkedin,link:"https://www.linkedin.com/in/tim-littau-a63510251/"},{platform:q.Email,link:"projects@tmlittau.com"}]},bn={title:"Projects",items:tn},wn={title:"Experiences",items:We},Sn={title:"Skills",items:pe},kn={title:"Resumé",item:"cv_littau.pdf"},Tn={title:"Search"},Dn={items:ye,title:"Education"};export{Dn as E,vn as H,te as I,pe as M,fn as N,bn as P,kn as R,Tn as S,gn as T,ie as a,yn as b,mn as c,un as d,wn as e,We as f,cn as g,me as h,dn as i,tn as j,hn as k,Sn as l,ln as o,de as t,pn as u};
